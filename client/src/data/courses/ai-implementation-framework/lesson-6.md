...
定性的評価の方法として、参加したスタッフに対して使い勝手、困った点、改善提案などを詳しくヒアリングするというインタビューがあります。また、複数のスタッフを集めてディスカッション形式で意見を収集するというフォーカスグループ、実際の使用場面を観察しマニュアルに書かれていない「実際の使われ方」を把握するという観察もあります。これらの方法により、定性的な評価が可能になります。
