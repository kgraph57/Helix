...
![研究計画書作成フロー](/Helix/assets/guides/research-protocol/images/research_protocol_workflow.png)
...
> 4.  本研究の意義: 上記のギャップを埋めるための、標準治療との比較による大規模RCTの必要性を主張。
...
> 統計解析計画
>
> 1.  解析対象集団: 原則として、Intention-to-Treat (ITT) 解析を主要解析とする。
> 2.  主要評価項目の解析:
