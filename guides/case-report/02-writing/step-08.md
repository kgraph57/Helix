...
平賀先生の論文[1]で強調されている**アブストラクトの4つの重要点**（①正確・簡潔・明瞭、②独立性、③Learning Pointの明記、④学会規定の遵守）を常に意識しながら執筆しましょう。
...
- **失敗**: 本文を書き終えた後に、内容を要約して抄録を作成する。
  - **対処法**: むしろ、**抄録を先に書く「Abstract-first」アプローチ**をお勧めします。抄録を論文全体の設計図と位置づけることで、本文の論理構成がぶれなくなり、執筆全体がスムーズに進みます。
